...
public record GenerateTokenQuery(Guid UserId, string Username, string Email) : IQuery<ErrorOr<string>>;
    ...
    : IQueryHandler<GenerateTokenQuery, ErrorOr<string>>
{
    ...
    {
        var jwtToken = _jwtTokenGenerator.GenerateToken(query.UserId, query.Username, query.Email);
